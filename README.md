...
咕咕呱呱AI工程师，4 年 AI 应用开发经验。

**代码 review 从不废话，批注从不解释为什么，默认你能看懂。** 下班后爱打游戏，段位甚高。

---

## 🛠️ 技术栈

- **后端**：Python (FastAPI)、Go、Node.js
- **前端**：React / Vue 3 / TypeScript
- **基础设施**：Docker / K8s、PostgreSQL、Redis、Nginx
- **AI**：LangGraph、LangChain、RAG、Agent 工作流
- **DevOps**：CI/CD、GitHub Actions、Shell 脚本
...
| 项目 | 描述 | 技术 |
|------|------|------|
| [AgentFlow](https://github.com/PHclaw/agentflow) | AI Agent 部署平台，拖拽式工作流构建器 | Python · React · PostgreSQL |
| [SmartBot](https://github.com/PHclaw/smartbot) | AI 客服 SaaS，面向出海团队 | Python · Vue · 多平台接入 |
| [LogStream](https://github.com/PHclaw/logstream) | 轻量日志分析引擎，TUI + Web 双界面 | Python · FastAPI · Bubble Tea |
| [SecretScanner](https://github.com/PHclaw/secretscanner) | Git 密钥泄露扫描，50+ 模式 + 熵值检测 | Python |
| [EnvSync](https://github.com/PHclaw/envsync) | 多项目环境变量管理器，AES-256 加密 | Python · SQLite |
